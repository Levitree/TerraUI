...
llmsLines.push('```')
llmsLines.push('')
llmsLines.push('Peer deps: `vue ^3.5`, `vue-router ^5`, `zod ^4`, `@tanstack/vue-table ^8`.')
llmsLines.push('')
llmsLines.push('```ts')
...
llmsLines.push('')
llmsLines.push(
  '- [Migration guide](docs/migration.md) — upgrading between versions (currently covers the Pinia removal in the next release after `0.7.x`).',
)
llmsLines.push('')
llmsLines.push('## Composables')
llmsLines.push('')
llmsLines.push('- [useModal](docs/composables/useModal.md) — promise-based modal orchestration.')
llmsLines.push('')
